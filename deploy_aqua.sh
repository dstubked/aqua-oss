...
AQUA_REGISTRY_USERNAME="xxxx@aquasec.com"
AQUA_REGISTRY_PASSWORD="xxxxxxx"
AQUA_DB_PASSWORD="xxxxxxxxx"
...
echo $AQUA_DB_IMAGE
echo $AQUA_CONSOLE_IMAGE
echo $AQUA_GATEWAY_IMAGE
...
echo "Aqua console user is $user"
echo "Aqua console password is $password"
